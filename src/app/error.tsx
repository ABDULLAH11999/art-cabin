...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-4xl flex-col items-center justify-center px-4 text-center">
      <p className="text-sm uppercase tracking-[0.5em] text-maroon">500</p>
      ...
      <div className="mt-8 flex gap-3">
        <button onClick={reset} className="rounded-full bg-maroon px-6 py-3 font-semibold text-white">
          Try Again
        </button>
